//https://editor.p5js.org/Fgomes/sketches/OSONa1eXL
//Link do YT: https://youtu.be/ERRVYN1QLkg
//Link do GitHub: https://franciscogomes5.github.io/math_hero2/
//Link do ColabEduc: http://www.colabeduc.org/projeto/show/592
//Link do video trailer: https://youtu.be/Kl4Qi998tJ4
...
//Telas 5.1 à 5.6: Todos os Game Over's do Jogo
  ...
  if(tela == 6){
    ...
    image(anm[contador%2], 180, 50, 120, 120)
    if(time>20){
      contador++
      time=0
    }
